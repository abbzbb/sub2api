...
func (h *OpenAIGatewayHandler) Responses(c *gin.Context) {
	...
	if err != nil {
		...
		h.errorResponse(c, http.StatusBadRequest, "invalid_request_error", buildBodyReadErrorMessage(err))
		return
	}
	...
	// #3782: 非法 reasoning.effort 本地 400，避免打到上游变成 upstream error / 冷却。
	if err := service.ValidateOpenAIResponsesReasoningEffort(body); err != nil {
