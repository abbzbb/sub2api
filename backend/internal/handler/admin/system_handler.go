...
func (h *SystemHandler) CheckUpdates(c *gin.Context) {
	...
	if err != nil {
		adminProbeFailed(c, http.StatusInternalServerError, reasonUpdateCheckFailed, genericUpdateCheckMessage(), err)
		return
	}
...
func (h *SystemHandler) GetRollbackVersions(c *gin.Context) {
	...
	if err != nil {
		adminProbeFailed(c, http.StatusInternalServerError, reasonRollbackListFailed, genericRollbackListMessage(), err)
		return
	}
	response.Success(c, gin.H{
		"versions": versions,
