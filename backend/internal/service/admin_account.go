...
func (s *adminServiceImpl) BulkUpdateAccounts(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
	...
	if len(input.Credentials) > 0 || input.ProxyID != nil || input.ProxyGroupID != nil || needMixedChannelCheck || hasLongContextBillingUpdate || openAISettings.any() || input.ProbeEnabled != nil || input.RateMultiplier != nil {
