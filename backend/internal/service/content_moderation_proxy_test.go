...
func (r *contentModerationTestProxyRepo) ListByGroupID(ctx context.Context, groupID int64) ([]Proxy, error) {
	return nil, nil
}
func (r *contentModerationTestProxyRepo) CountByGroupID(ctx context.Context, groupID int64) (int64, error) {
	return 0, nil
}
func (r *contentModerationTestProxyRepo) UpdateHealthAudit(context.Context, int64, int, *time.Time, string) error {
	return nil
}
func (r *contentModerationTestProxyRepo) GetHealthAudit(context.Context, int64) (int, *time.Time, string, error) {
	return 0, nil, "", nil
}
func (r *contentModerationTestProxyRepo) CountHealthIsolated(context.Context) (int64, error) {
	return 0, nil
}
func (r *contentModerationTestProxyRepo) ListHealthIsolated(context.Context, int) ([]Proxy, error) {
	return nil, nil
}
func (r *contentModerationTestProxyRepo) ListHealthIsolatedByID(context.Context, int64, int) ([]Proxy, error) {
	return nil, nil
}
func (r *contentModerationTestProxyRepo) ClearAccountProxyBindings(context.Context, int64) (int64, error) {
	return 0, nil
}
func (r *contentModerationTestProxyRepo) UpdateStatusWithHealthIsolation(context.Context, int64, string, int, *time.Time, string, string, *string, bool) (bool, error) {
	return true, nil
}
