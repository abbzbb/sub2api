export default {
    ...
    proxies: {
      ...
      healthScanRunning: 'Scanning...',
      healthScanDone:
        'Health scan done: probed {probed}, isolated {isolated}, recovered {recovered}, skipped {skipped}, errors {errors}',
      healthScanFailed: 'Health scan failed',
      healthDetail: 'Health Detail',
      healthIsolatedByHealth: 'Probe failed',
      healthFailCount: 'Fail streak',
      healthSuccessCount: 'Success streak',
      healthLastError: 'Last error',
      healthLastChecked: 'Last checked',
      healthExitIP: 'Exit IP',
      healthThreshold: 'Thresholds',
      healthAutoRecover: 'Auto recover',
      healthProbeMode: 'Probe mode',
      healthDBAudit: 'DB audit',
      testFailed: 'Failed',
    ...
    // Proxy Groups (proxy pools)
    proxyGroups: {
      title: 'Proxy Pools',
      description: 'Manage proxy groups and selection strategies',
      create: 'Create Proxy Pool',
      edit: 'Edit Proxy Pool',
      delete: 'Delete Proxy Pool',
      search: 'Search proxy pools...',
      name: 'Name',
      namePlaceholder: 'Enter pool name',
      nameRequired: 'Name is required',
      descriptionLabel: 'Description',
      strategy: 'Strategy',
      status: 'Status',
      stickyByAccount: 'Sticky by account (fixed egress per account)',
      stickyHint: 'Recommended for Grok accounts so OAuth refresh and relay share the same exit IP.',
      healthFailThreshold: 'Health fail threshold',
      healthSuccessThreshold: 'Health recover threshold',
      healthThresholdGlobal: '0 = use global config',
      healthThresholdHint:
        'Overrides global proxy_health thresholds; leave empty or 0 to use global fail/success thresholds.',
      ...
      emptyDesc: 'Create a pool, then bind accounts to rotate egress by strategy.',
      deleteConfirm:
        "Delete proxy pool '{name}'? Delete is rejected while members or accounts are still bound.",
      created: 'Proxy pool created',
      updated: 'Proxy pool updated',
      deleted: 'Proxy pool deleted',
      failedToLoad: 'Failed to load proxy pools',
      failedToSave: 'Failed to save proxy pool',
      failedToDelete: 'Failed to delete proxy pool',
      columns: {
        name: 'Name',
        strategy: 'Strategy',
        members: 'Members',
