export default {
    accounts: {
      ...
      status: {
        ...
        grokFreeRecoveryPending: 'Removed from scheduling until a successful Grok 4.5 recovery probe.',
        grokFreeRecoveryAwaitingProbe: 'Waiting for recovery probe',
        grokFreeRecoveryNextProbe: 'Next probe: {time}',
        grokFreeRecoveryLastProbe: 'Last probe: {time}',
        grokFreeRecoveryProbeResult: 'Last result: {result}',
      ...
      oauth: {
        ...
        grok: {
          ...
          skipRiskFlagged: 'Check grok.com risk before import and skip flagged accounts (check failures do not block import)',
          checkSSORisk: 'Check risk only',
          checkSSOSummary: 'Checked {total}: flagged {flagged}, clean {clean}, unknown {unknown}, error {error}',
          checkSSOFlagged: '{count} flagged account(s) found',
          checkSSODone: 'Risk check finished',
          failedToCheckSSO: 'Failed to check Grok account risk',
          riskFlagged: 'Flagged',
          riskClean: 'Clean',
          riskUnknown: 'Risk unknown',
          riskIP: 'IP soft flag',
          riskAccount: 'Account risk',
          riskJWT: 'Token risk',
