export default {
    settings: {
      ...
      customMenu: {
        ...
        showOpenInNewTab: 'Show "Open in new tab" button',
        showOpenInNewTabHint: 'When off, the floating button on iframe pages is hidden (sidebar entry is unchanged).',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
      ...
      payment: {
        ...
        validationEasyPayCustomMethodTypeInvalid: 'Custom EasyPay payment types may only contain lowercase letters, digits, dots, underscores, and hyphens',
        validationEasyPayCustomMethodUpstreamTypeInvalid: 'EasyPay upstream types may only contain lowercase letters, digits, dots, underscores, and hyphens',
