export default {
	...
	proxies: {
		...
		batchTest: "批量测试",
		healthScan: "轮询测活",
		healthScanRunning: "测活中...",
		healthScanDone: "测活完成：探测 {probed}，隔离 {isolated}，恢复 {recovered}，跳过 {skipped}，错误 {errors}",
		healthScanFailed: "轮询测活失败",
		healthDetail: "健康详情",
		healthIsolatedByHealth: "测活失败",
		healthFailCount: "连续失败",
		healthSuccessCount: "连续成功",
		healthLastError: "最近错误",
		healthLastChecked: "最近检测",
		healthExitIP: "出口 IP",
		healthThreshold: "阈值",
		healthAutoRecover: "自动恢复",
		healthProbeMode: "探测模式",
		healthDBAudit: "数据库审计",
		testFailed: "失败",
		latencyFailed: "链接失败",
	...
	proxyGroups: {
		title: "代理池",
		description: "管理代理分组与选择策略",
		create: "新建代理池",
		edit: "编辑代理池",
		delete: "删除代理池",
		search: "搜索代理池...",
		name: "名称",
		namePlaceholder: "请输入代理池名称",
		nameRequired: "请输入代理池名称",
		descriptionLabel: "描述",
		strategy: "选择策略",
		status: "状态",
		stickyByAccount: "按账号粘性（同账号固定出口）",
		stickyHint: "推荐给 Grok 账号开启，保证 OAuth 刷新与中继同出口 IP。",
		healthFailThreshold: "测活失败阈值",
		healthSuccessThreshold: "测活恢复阈值",
		healthThresholdGlobal: "0 = 使用全局配置",
		healthThresholdHint: "覆盖全局 proxy_health 阈值；留空或 0 表示使用全局 fail_threshold / success_threshold。",
		members: "成员代理",
		membersSearch: "搜索代理名称或地址...",
		membersSelected: "已选 {count} 个",
		membersFiltered: "筛选 {count} 个",
		selectPage: "全选本页",
		selectAllFiltered: "全选筛选结果",
		clearSelection: "清空已选",
		noMatchingProxies: "没有匹配的代理",
		noProxies: "暂无可用代理，请先在「代理列表」中添加。",
		emptyTitle: "暂无代理池",
		emptyDesc: "创建代理池后，可将账号绑定到组，由服务端按策略轮换出口。",
		deleteConfirm:
			"确定删除代理池 '{name}' 吗？组内仍有成员或账号绑定时会拒绝删除。",
		created: "代理池创建成功",
		updated: "代理池更新成功",
		deleted: "代理池删除成功",
		failedToLoad: "加载代理池失败",
		failedToSave: "保存代理池失败",
		failedToDelete: "删除代理池失败",
		columns: {
			name: "名称",
			strategy: "策略",
			members: "成员数",
