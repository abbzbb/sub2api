export default {
    ...
    proxies: {
      ...
      healthScanDone:
        '测活完成：探测 {probed}，隔离 {isolated}，恢复 {recovered}，跳过 {skipped}，错误 {errors}',
    ...
    proxyGroups: {
      ...
      healthThresholdHint:
        '覆盖全局 proxy_health 阈值；留空或 0 表示使用全局 fail_threshold / success_threshold。',
      members: '成员代理',
      ...
      deleteConfirm: "确定删除代理池 '{name}' 吗？组内仍有成员或账号绑定时会拒绝删除。",
      created: '代理池创建成功',
      updated: '代理池更新成功',
      deleted: '代理池删除成功',
