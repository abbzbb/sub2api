export default {
    accounts: {
      ...
      status: {
        ...
        grokFreeRecoveryPending: '当前不参与调度；Grok 4.5 恢复探测成功后自动恢复。',
        grokFreeRecoveryAwaitingProbe: '等待恢复探测',
        grokFreeRecoveryNextProbe: '下次探测：{time}',
        grokFreeRecoveryLastProbe: '上次探测：{time}',
        grokFreeRecoveryProbeResult: '上次结果：{result}',
      ...
      bulkActions: {
        ...
        checkGrokRisk: '检查 Grok 风控',
        checkGrokRiskSuccess: 'Grok 风控检查完成：标记 {flagged}，干净 {clean}，失败 {error}',
        checkGrokRiskNoAccounts: '当前选择中没有 Grok 账号',
      ...
      bulkEdit: {
        ...
        syncUpstreamModelsHint: '将用所选账号中第一个可同步的账号拉取上游模型列表，再写入本次批量白名单。'
      },
      ...
      oauth: {
        ...
        grok: {
          ...
          skipRiskFlagged: '导入前检查 grok.com 风控，跳过被标记账号（检测失败不阻断导入）',
          checkSSORisk: '仅检查风控',
          checkSSOSummary: '检查完成：共 {total}，标记 {flagged}，干净 {clean}，未知 {unknown}，失败 {error}',
          checkSSOFlagged: '发现 {count} 个被标记账号',
          checkSSODone: '风控检查完成',
          failedToCheckSSO: 'Grok 风控检查失败',
          riskFlagged: '已风控',
          riskClean: '未风控',
          riskUnknown: '风控未知',
          riskIP: 'IP 软标记',
