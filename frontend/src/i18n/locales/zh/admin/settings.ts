export default {
    settings: {
      ...
      customMenu: {
        ...
        visibilityUser: '普通用户',
        visibilityAdmin: '管理员',
        showOpenInNewTab: '显示「新窗口打开」按钮',
        showOpenInNewTabHint: '关闭后，iframe 内嵌页右上角不再显示浮动按钮（不影响侧栏入口本身）。',
        add: '添加菜单项',
        remove: '删除',
        moveUp: '上移',
        moveDown: '下移',
      ...
      payment: {
        ...
        validationEasyPayCustomMethodTypeInvalid: '易支付自定义支付方式只能包含小写字母、数字、点、下划线和短横线',
        validationEasyPayCustomMethodUpstreamTypeInvalid: '易支付上游 type 只能包含小写字母、数字、点、下划线和短横线',
