...
curl -sSL https://raw.githubusercontent.com/abbzbb/sub2api/self/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/abbzbb/sub2api/releases)
